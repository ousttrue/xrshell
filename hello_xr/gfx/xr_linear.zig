...
pub fn XrMatrix4x4f_Multiply(a: XrMatrix4x4f, b: XrMatrix4x4f) XrMatrix4x4f {
...
pub fn XrMatrix4x4f_InvertRigidBody(src: XrMatrix4x4f) XrMatrix4x4f {
    var result: XrMatrix4x4f = undefined;
    result.m[0] = src.m[0];
    result.m[1] = src.m[4];
    result.m[2] = src.m[8];
...
pub fn XrMatrix4x4f_CreateTranslation(x: f32, y: f32, z: f32) XrMatrix4x4f {
    var result: XrMatrix4x4f = undefined;
    result.m[0] = 1.0;
    result.m[1] = 0.0;
    result.m[2] = 0.0;
...
pub fn XrMatrix4x4f_CreateScale(x: f32, y: f32, z: f32) XrMatrix4x4f {
    var result: XrMatrix4x4f = undefined;
    result.m[0] = x;
    result.m[1] = 0.0;
    result.m[2] = 0.0;
...
pub fn XrMatrix4x4f_CreateFromQuaternion(quat: c.XrQuaternionf) XrMatrix4x4f {
...
pub fn XrMatrix4x4f_CreateTranslationRotationScale(translation: c.XrVector3f, rotation: c.XrQuaternionf, scale: c.XrVector3f) XrMatrix4x4f {
    const scaleMatrix = XrMatrix4x4f_CreateScale(scale.x, scale.y, scale.z);

    const rotationMatrix = XrMatrix4x4f_CreateFromQuaternion(rotation);

    const translationMatrix = XrMatrix4x4f_CreateTranslation(translation.x, translation.y, translation.z);

    const combinedMatrix = XrMatrix4x4f_Multiply(rotationMatrix, scaleMatrix);
    return XrMatrix4x4f_Multiply(translationMatrix, combinedMatrix);
}

pub fn XrMatrix4x4f_CreateFromRigidTransform(s: c.XrPosef) XrMatrix4x4f {
    const identityScale: c.XrVector3f = .{ .x = 1.0, .y = 1.0, .z = 1.0 };
    return XrMatrix4x4f_CreateTranslationRotationScale(s.position, s.orientation, identityScale);
}
...
pub fn XrMatrix4x4f_CreateProjection(
...
pub fn XrMatrix4x4f_CreateProjectionFov(graphicsApi: GraphicsAPI, fov: c.XrFovf, nearZ: f32, farZ: f32) XrMatrix4x4f {
    ...
    return XrMatrix4x4f_CreateProjection(graphicsApi, tanLeft, tanRight, tanUp, tanDown, nearZ, farZ);
}
